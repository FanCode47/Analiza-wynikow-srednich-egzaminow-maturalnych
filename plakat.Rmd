...
Wykres pokazuje średnią różnicę wyników maturalnych między kobietami a mężczyznami dla każdego przedmiotu, gdzie kolor różowy oznacza przewagę kobiet, a czarny – mężczyzn.
...
Heatmapa przedstawia współczynniki korelacji pomiędzy średnimi wynikami z poszczególnych przedmiotów maturalnych. Kolor zielony oznacza dodatnią korelację (im silniejsza, tym ciemniejszy kolor), natomiast jasne obszary wskazują na brak związku między przedmiotami.  
